...
footnote1 
    "Pearson Chi-Sq Test shows p-value > 0.05, therefore failed to teject Ho s.t. there is not enough evidence to show significant correlation between net migration and death rate."
    ;
...
title2 
    ‘Rationale: This would help determine whether death rate has any effect on the countries's Net Migration.’
    ;

footnote1 
    "Based on the above output, there's no clear inferential pattern for predicting the net migration rate based on a country's death rate since cell counts don't tend to follow trends for increasing or decreasing consistently."
    ;
